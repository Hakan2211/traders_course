  ...
  const sketch = useCallback(
    (p: p5, parentEl: HTMLDivElement) => {
      ...
      const drawChart = (
        ...
        // Panel background
        p.noStroke()
        p.fill(15, 23, 42, 160) // Slate-900 with alpha to match EnvironmentWrapper
    ...
    <div className="w-full h-full">
      ...
      >
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-md text-sm font-medium bg-blue-600/80 hover:bg-blue-600 text-white"
